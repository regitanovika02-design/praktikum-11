...
<head>
    ...
    <link href="{{ asset('SBADMIN22/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet" type="text/css">
    <!-- Custom styles for this template-->
    <link href="{{ asset('SBADMIN22/css/sb-admin-2.min.css') }}" rel="stylesheet">
    <!-- Custom styles for this template-->
...
<body id="page-top">
    ...
    <script src="js/SBADMIN22.min.js"></script>
